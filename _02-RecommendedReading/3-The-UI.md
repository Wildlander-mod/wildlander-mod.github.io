...
1. **Read [Introduction to Wildlander](https://wiki.wildlandermod.com/02-RecommendedReading/4-An-Introduction-to-wildlander/)** - Learn core survival mechanics and systems
2. **Read [Changes From Vanilla](https://wiki.wildlandermod.com/02-RecommendedReading/5-Changes-From-Vanilla/)** - See what's different from vanilla Skyrim
