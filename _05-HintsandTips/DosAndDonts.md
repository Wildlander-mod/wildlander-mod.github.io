...
- Breakdown items that you don't intend to sell and the value/weight is too high, but want to convert for crafting - it can reduce the carry weight of the item significantly.  
...
- Don't pick up everything, only pick up items that you intend to sell or breakdown for crafting. Only pick up food when you need it.