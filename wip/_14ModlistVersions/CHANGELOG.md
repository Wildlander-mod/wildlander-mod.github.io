...
* **Animation Framework Upgrade** — Migrated from DAR to Open Animation Replacer (OAR) for better performance and flexibility
* **Quality of Life Improvements** — Added multiple convenience features and bug fixes across core gameplay systems

### [Bugfixes](/14ModlistVersions/R4-Release-Notes-Bugfixes/)
### [Mod Changes](/14ModlistVersions/R4-Release-Notes-Mod-Changes/)
