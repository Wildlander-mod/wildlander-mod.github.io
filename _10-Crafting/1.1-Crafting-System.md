...
<p style="margin-left: 40px">SmithingXPBonus = 1.15 </p>
else if Player has "well rested marriage" buff 
<p style="margin-left: 40px">SmithingXPBonus = 1.15 </p>
else if player has "well rested" buff 
<p style="margin-left: 40px">SmithingXPBonus = 1.10</p>
else if player has "rested" buff 
<p style="margin-left: 40px">SmithingXPBonus = 1.05 </p>
else
<p style="margin-left: 40px">SmithingXPBonus = 1 </p>

if Player has the warrior stone <br>
<p style="margin-left: 40px">SmithingXPBonus = SmithingXPBonus + 0.2</p>
