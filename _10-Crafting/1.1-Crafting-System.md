...
|---|---|
| [Breakdown Recipes](https://wiki.wildlandermod.com/10-Crafting/Breakdown-Recipes) | Breaking down items into raw materials |
| [Armor Table](https://wiki.wildlandermod.com/10-Crafting/Armor-Table-Recipes) | Armor crafting and modification |
| [Sharpening Wheel](https://wiki.wildlandermod.com/10-Crafting/Sharpening-Wheel) | Weapon maintenance and sharpening |
| [Blacksmithing](https://wiki.wildlandermod.com/10-Crafting/Blacksmith) | Weapon and metal gear crafting |
| [Ammunition](https://wiki.wildlandermod.com/10-Crafting/Ammunition) | Arrows, bolts, and projectiles |
| [Cooking](https://wiki.wildlandermod.com/10-Crafting/cookingrecipes) | Food and drink preparation |
| [Jewelry](https://wiki.wildlandermod.com/10-Crafting/Jewelry) | Rings, amulets, and gemstone polishing |
| [Tailoring](https://wiki.wildlandermod.com/10-Crafting/Tailor) | Clothing and apparel |
| [Alchemy](https://wiki.wildlandermod.com/10-Crafting/AlchIng) | Potions and alchemical ingredients |
| [Raw Materials](https://wiki.wildlandermod.com/10-Crafting/raw) | Processing and refining materials |
| [Misc & Survival](https://wiki.wildlandermod.com/10-Crafting/Misc) | Miscellaneous items and survival gear |

**[View All Recipes Spreadsheet](https://airtable.com/shrn0GCmAPLiAo42L){:target="_blank"}** - Complete crafting reference
