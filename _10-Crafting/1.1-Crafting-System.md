...
<font style="color: #6d9eeb;"><strong>SmithingXPBonus 

	if player has completed the quest Unfathomable Depths
		SmithingXPBonus = 1.15
	else if Player has "rested marriage" buff
		SmithingXPBonus = 1.15
...
<br>
<strong>NumCrafted</strong> = 3 = 1st craft, 2 = second craft, 1 = 3rd craft, 0 = 4th or more( Once you've crafted the item three times, further copies will result in part 2 calculating zero).
</div>
...
This is Unchanged from Vanilla.
