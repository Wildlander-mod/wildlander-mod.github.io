...
The [Frostfall temperature gauges](https://wiki.wildlandermod.com/02-RecommendedReading/3-The-UI#frostfall-temperature-gauges) on the UI page are a visual aid to these settings.
...
1. **Endurance perks.** Accessible from any built campfire, Endurance skill perks can enhance your ability to survive in various circumstances. See the [Endurance Skill](https://wiki.wildlandermod.com/03-YourFirstCharacter/camping/#endurance-skill) for more information.
