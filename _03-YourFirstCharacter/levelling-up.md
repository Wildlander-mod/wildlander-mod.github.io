...
nav_order: 4
description: Leveling Up in Wildlander
has_toc: true
---
...
1. **Whiterun Sewers (Levels 1-5)** - Safe starter area
...
4. **Starter Dungeons (Levels 15-20)**
   - Helgen (bandits)
...
**How to use:**
1. **Equip a spell** in one or both hands
2. **Activate the Spell Research Journal** from your inventory
3. **Select "Research"** to enter research mode (wait for initialization)
...
5. **Exit research mode** by activating the journal again
6. **Sleep to remove fatigue** (1 hour of study = 2 hours of sleep needed)
...
5. **Farm Smithing** by crafting simple items twice each
6. **Pick up easy Missive Board quests:** Mudcrab parts, wolf pelts, skeevers—these are quick kills
