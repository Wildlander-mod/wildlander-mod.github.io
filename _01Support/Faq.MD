...
The Wildlander mod list is completely rebuilt from the ground up, so some of the features you maybe used to are not available because they haven't been converted to SE and/or it was too complex for us to do so. An example of this is the [Atronach Crossing - Build Your Own Home](https://www.nexusmods.com/skyrim/mods/78990) mod. Additionally, some of the mods which ARE available for SE have major changes which would require rebalancing, such as [Heljarchen Farm](https://www.nexusmods.com/skyrim/mods/50992), or simply don't work such as in the case of [Dark Dungeons for ENB](https://www.nexusmods.com/skyrim/mods/12454), [Google's Locked City Gates](https://www.nexusmods.com/skyrimspecialedition/mods/13133), and the full version of [Enhanced Skyrim Factions: The Companions Guild](https://www.nexusmods.com/skyrim/mods/22650).
...
You can download and install Wildlander from [here](https://www.wildlandermod.com/download)

----
# How do I donate to the project?

If you would like to buy your friendly neighborhood support person a drink of <a href="https://ko-fi.com/wildlanderteam"><img src="http://wiki.wildlandermod.com/Assets/kofi.png"></a>

Or support Dylan himself on <a href="https://www.patreon.com/dylanbperry"><img src="http://wiki.wildlandermod.com/Assets/Patreon.png"></a>
...
If you already have the DLC, you can still install the content as it is ignored during the installation process and not copied over. 

----------

# Can I add the Creation Club content / Anniversary Edition DLC to my Wildlander install?

No, this content counts as customization. It is unsupported and untested. Some of them are known to conflict and cause crashes and issues with other mods in the list.
...
Then follow the instructions [here](http://wiki.wildlandermod.com/09-How-Do-i/How-to-update/).
...
This Mod [Large Sector fix](https://www.nexusmods.com/skyrimspecialedition/mods/71567?tab=description) will correct the issue, and will be included as standard on the next major release.
