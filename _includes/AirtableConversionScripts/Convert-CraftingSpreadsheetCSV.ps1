...
$md = @()
$md += '| Produced Item Name | Crafting Workbench | Qty Made | Perks Needed | Proximity | Items Required | Additional Requirements |'
$md += '|:---|:---|:---:|:---|:---|:---|:---|'
...
foreach ($row in $data) {
  if ($row.'Produced Item Name') {
    ...
    $md += "| $itemName | $workbench | $qtyMade | $perks | $proximity | $items | $additional |"
  }
}
