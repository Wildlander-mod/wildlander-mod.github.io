# Convert Jewelry Recipes CSV to Markdown Table
$csvPath = 'DataFromAirtable/All Crafting Recipes-Jewellers Recipes.csv'
$outputFile = 'JewelryRecipesTable.md'

$data = Import-Csv $csvPath
$md = @()
$md += '| Produced Item Name | Qty Made | Perks Needed | Proximity | Items Required | Additional Requirements |'
$md += '|:---|:---:|:---|:---|:---|:---|'
