...
$md = @()
$md += '| Produced Item Name | Perks Needed | Proximity | Qty Made | Items Required | Additional Requirements |'
$md += '|:---|:---|:---|:---:|:---|:---|'
...
foreach ($row in $data) {
  if ($row.'Produced Item Name') {
    ...
    $md += "| $itemName | $perksNeeded | $proximity | $qtyMade | $itemsRequired | $additionalRequirements |"
  }
}
